...
from ..ai_engine.chroma_store import ChromaStore as _ChromaStore, ChromaStoreError as _ChromaStoreError
...
class RAGEngine:
    ...
    def _get_chroma_store(self) -> _ChromaStore:
        ...
        if self.chroma_store is None:
            self.chroma_store = self._chroma_store_class(embedding_generator=self.embedding_generator)
